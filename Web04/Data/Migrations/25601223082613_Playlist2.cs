...
namespace Web04.Data.Migrations
{
    public partial class Playlist2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("SELECT * INTO dbo.AlbumsBackup FROM dbo.Albums");
            migrationBuilder.Sql("SELECT * INTO dbo.SongsBackup FROM dbo.Songs");
            migrationBuilder.Sql("DELETE dbo.Songs");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_MusicItem_Playlist_PlaylistId",
                table: "MusicItem",
                column: "PlaylistId",
